...
PATIENT_COLUMNS = {
    ...
    "microarea": "TEXT",
    "area_team": "TEXT",
    "record_responsible": "TEXT",
    "first_trimester_ultrasound_weeks": "REAL",
    "weight_kg": "REAL",
    "height_cm": "REAL",
    "bmi": "REAL",
    "weight_gain_kg": "REAL",
    ...
    "capillary_glucose": "REAL",
    "fetal_heartbeat": "TEXT",
    "uterine_height_cm": "REAL",
    "vaccination_status": "TEXT",
    "rapid_tests_status": "TEXT",
    "trimester_exams_status": "TEXT",
    "dental_evaluation_status": "TEXT",
    "pregnancy_booklet_updated": "INTEGER DEFAULT 0",
    "risk_factor_1": "TEXT",
    "risk_factor_2": "TEXT",
    "risk_factor_3": "TEXT",
    "hypertensive_disease_status": "TEXT",
    "preeclampsia_risk_factors": "TEXT",
    "preeclampsia_prophylaxis": "TEXT",
    "uti_status": "TEXT",
    "uti_treatment": "TEXT",
    "uti_cure_control": "TEXT",
    "gestational_diabetes_status": "TEXT",
    "medications_in_use": "TEXT",
    "urgent_care_last_year": "INTEGER DEFAULT 0",
    "hospitalizations_last_year": "INTEGER DEFAULT 0",
    "reproductive_planning_status": "TEXT",
    "care_plan_defined": "INTEGER DEFAULT 0",
    "care_plan_monitored": "INTEGER DEFAULT 0",
    "shared_care": "INTEGER DEFAULT 0",
    "next_scheduled_visit": "TEXT",
    "active_search_reason": "TEXT",
    "maternity_linked": "INTEGER DEFAULT 0",
    "maternity_risk_updated": "INTEGER DEFAULT 0",
    "postpartum_home_visit_7d": "INTEGER DEFAULT 0",
    "postpartum_consult_7d": "INTEGER DEFAULT 0",
    "postpartum_consult_42d": "INTEGER DEFAULT 0",
    "postpartum_consult_after_42d": "INTEGER DEFAULT 0",
    "breastfeeding_status": "TEXT",
    "postpartum_intercurrences": "TEXT",
    "postpartum_reproductive_planning": "TEXT",
    "delivery_type": "TEXT",
    "discharge_date": "TEXT",
    "delivery_intercurrences": "TEXT",
    "outcome": "TEXT",
    "high_risk_shared_care": "INTEGER DEFAULT 0",
    "active_search": "INTEGER DEFAULT 0",
}
